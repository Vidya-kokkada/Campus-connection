...
(2, 'Shruthi K', 'shruthik138@gmail.com', '09902870859', 'good college', '2023-05-24 08:48:14'),
(3, 'ashmitha', 'ashmitha@gmail.com', '9876543211', 'nice cateen', '2023-05-26 05:46:54');
...
(1, 'Admin', 'admin', 8979555558, 'admin@gmail.com', '0192023a7bbd73250516f069df18b500', '2019-10-11 04:36:52');
...
CREATE TABLE `tblevents` (
  ...
  `event_description` varchar(25) NOT NULL,
  `event_date` date NOT NULL,
  `event_time` time NOT NULL,
  `event_location` varchar(25) NOT NULL,
  `event_image` varchar(25) NOT NULL,
...
INSERT INTO `tblevents` (`ID`, `event_name`, `event_description`, `event_date`, `event_time`, `event_location`, `event_image`, `event_category`) VALUES
(1, 'ganesh', 'chaturthi', '2023-05-27', '13:08:00', 'BCC ', 'event1.png', 'culture');
...
(1, 'aboutus', 'About Us', 'Government First Grade College for women, Balmatta, Mangaluru  was established in July 2007 by the Department of Collegiate Education, Government of Karnataka to cater the educational needs of the economically and socially marginalized sections of the region. The College is located in heart of Mangaluru city, Dakshina Kannada District of Karnataka. The College is affiliated to Mangalore University.  It is also recognized under section 2f of the UGC Act. The College offers the following undergraduate programs, namely B.A., B.Sc., B.Com. B.C.A and B.B.A. The College is founded by the Government of Karnataka. The norms and procedures for recruitment of teaching and non teaching staff of the college are as per the Government rules in matters related to administration, service rules, finance etc. and the Principal of the college acts as per the existing rules and the instructions of the Government. College has well connected on all sides with frequent modes of travel and being the only Govt. Women’s College in the city, no doubt it is  favoured by under graduate students irrespective of caste or creed. Moreover, the college has a very earnest and talented faculty of associate professors & assistant professors who go that extra mile to motivate and facilitate their students to excel not only in academics, but also in co-curricular and extra-curricular activities. This apart, the college boasts of excellent academic results owing to which a large no. of students seek admission  in the college.', NULL, NULL, NULL),
(2, 'contactus', 'Contact Us', 'Balmatta,Mangalore', 'infodata@gmail.com', 7896541236, NULL);
...
INSERT INTO `tblparticipants` (`ID`, `event_id`, `participant_name`, `participant_email`, `participant_phone`) VALUES
(11, 1, 'vidya', 'vidya@gmail.com', '9876543211');
...
(1, 'college will start from 08 May', 'Consult your class teacher.', '2022-01-20 09:11:57'),
...
INSERT INTO `tblresult` (`ResultID`, `ResultTitle`, `ClassId`, `ResultImage`, `CreatedDate`) VALUES
(3, 'First Internal', 1, 'result1.png', '2023-05-26 07:20:15');
...
(6, 'Vidya', 'vidya@gmail.com', '1', 'Female', '2018-06-18', '202441522131', 'Sriram', 'Nikitha', 9876543211, 9876543211, 'Kanakanady', 'vidya', '7cdd5a2b0328204d43822424ae922fb4', '1c0b56d274b5637256ec712f64f70f281684400166.jpg', '2023-05-18 08:56:06');
...
--
ALTER TABLE `tblresult`
  ADD CONSTRAINT `tblresult_ibfk_1` FOREIGN KEY (`ClassId`) REFERENCES `tblclass` (`ID`);
COMMIT;
