...
{               ?>
            ...
            <li class="nav-item">
			 ...
			 <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="add-events.php"> Add Events </a></li>
                 <!-- <li class="nav-item"> <a class="nav-link" href="manage-result.php"> Manage Result </a></li>-->
                </ul>
              </div>
            </li>
			 <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="view-feedback.php"> View Feedbacks </a></li>
                 <!-- <li class="nav-item"> <a class="nav-link" href="manage-result.php"> Manage Result </a></li>-->
                </ul>
              </div>
            </li>
			 <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="view-participants.php"> View event participants </a></li>
                 <!-- <li class="nav-item"> <a class="nav-link" href="manage-result.php"> Manage Result </a></li>-->
                </ul>
              </div>
            </li>
